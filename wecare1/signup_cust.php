    ...
    <header>
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if($_POST['create_pass']==$_POST['con_pass']){
                ...
                $_SESSION['area'] = $area;
                $sql = "insert into user_customer(name,gender,nid,tel_num,s_tel_num,per_add,pre_add,mail_id,area,password) values('$name','$gender','$nid','$tel_num','$s_tel_num','$per_add','$pre_add','$mail_id','$area','$password')";
